...
class Attendance(db.Model):
    ...
    module_id = db.Column(
        db.String, db.ForeignKey("dbo.module_master_temp.module_code")
    )
    module = db.relationship(
        "ModuleMasterTemp", backref=db.backref("attendance", lazy=True)
    )
    ...
    remark_attendance = db.Column(db.String(255))
    ...
    def json(self):
        return {
            ...
            "remark_attendance": self.remark_attendance,
