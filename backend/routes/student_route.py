...
from utils.common.upload_leave_attendance import *
...
@student_routes.route("/upload_leave_attendance", methods=["POST"])
def get_upload_student_remarks():
    return upload_leave_attendance()


@student_routes.route("/get_leave_students", methods=["POST"])
def get_leave_students_filer_api():
    return get_leave_students_filter()
